      ...
      <div class="row">
        <div class="card">
          ...
          <table class="table table-bordered">
              ...
              <tbody>
                  <?php $sl=0;
                  $data = $conn->query("SELECT orders.*,products.name as pName,products.photo, customer_login.user_name FROM `orders` JOIN products on orders.product_id= products.id JOIN customer_login on orders.customer_id= customer_login.id");
                  ...
                  <tr>
                      ...
                      <td>
                         <img src="../eComers/src/assets/img/upload/product/<?php echo $order['photo'] ?>" style='width:60px;'>    
                      </td>

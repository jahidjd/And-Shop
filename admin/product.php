          ...
          <form action="productInsert.php" method="POST" enctype="multipart/form-data">
              <table class="table table-bordered">
                  <tr>
                      ...
                      <td colspan="2">
                          <select name="category_id" id="" class="form-control">
                              ...
                              <?php $data = $conn->query("SELECT * FROM product_category");
                  ...
                  <tr>
                      ...
                      <td>Hover Photo</td>
                      <td><input type="file" class="form-control" name="hover_photo"></td>
                  </tr>
                  <tr>
                      <td>Details</td>
                      <td colspan="4">
                  ...
                  <tr>
                      <td>Details</td>
                      <td colspan="4">
                          <textarea name="long_details" id="" cols="30" rows="10" class="form-control"></textarea>
                      </td>
                  </tr>
                  <tr>
                      <td>Price</td>
                  ...
                  <tr>
                      ...
                      <td>Materials</td>
                      <td><input type="text" name="materials" class="form-control"></td>
                  </tr>
                  <tr>
                      <td>Other Info</td>
                      <td colspan="3"><input type="text" name="other_info" class="form-control"></td>
                      
                  </tr>
                  <tr>
                    <td>Status</td>
                    <td><input type="text" name="status" class="form-control"></td>
                  <td colspan="2"><input type="submit" value="Insert" class='form-control btn btn-info'></td>
                  </tr>
              </table>
          </form>
        </div>
